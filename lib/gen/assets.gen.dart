...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/Icon-App-40x40@1x.png
  AssetGenImage get iconApp40x401x =>
      const AssetGenImage('assets/icons/Icon-App-40x40@1x.png');

  /// File path: assets/icons/Icon-App-40x40@2x.png
  AssetGenImage get iconApp40x402x =>
      const AssetGenImage('assets/icons/Icon-App-40x40@2x.png');

  /// File path: assets/icons/Icon-App-40x40@3x.png
  AssetGenImage get iconApp40x403x =>
      const AssetGenImage('assets/icons/Icon-App-40x40@3x.png');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/flutter-dash.png
  AssetGenImage get flutterDashPng =>
      const AssetGenImage('assets/images/flutter-dash.png');

  /// File path: assets/images/flutter-dash.svg
  SvgGenImage get flutterDashSvg =>
      const SvgGenImage('assets/images/flutter-dash.svg');

  /// List of all assets
  List<dynamic> get values => [flutterDashPng, flutterDashSvg];
}
